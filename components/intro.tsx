  ...
  return (
    ...
    >
      ...
      >
        <Link
          href="#contact"
          className="group bg-gray-950 text-white px-7 py-3 items-center gap-2 rounded-full flex outline-none focus:scale-110 hover:scale-110 hover:bg-gray-950 active:scale-105 transition"
          onClick={() => {
